...
macro_rules! __export_rust_template_impl {
  ...
  $($path_to_types_root)*::__export_world_rust_template_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.24.0:rust-template:encoded world"]
#[doc(hidden)]
...
\0\x05ping2\x01\0\x04\x01%component:rust-template/rust-template\x04\0\x0b\x13\x01\
