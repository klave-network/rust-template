...
pub mod klave {
    ...
    pub mod sdk {
        ...
        pub mod sdk {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn read_ledger(table: &str, key: &[u8]) -> Result<_rt::Vec<u8>, _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn write_ledger(table: &str, key: &[u8], value: &[u8]) -> Result<(), _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn remove_from_ledger(table: &str, key: &[u8]) -> Result<(), _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn load_lightgbm_model(name: &str, model: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn load_key(key_name: &str) -> Result<_rt::Vec<u8>, _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn generate_simple_encryption_key(key_name: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn generate_simple_signing_key(key_name: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn simple_sign(key_name: &str, txt: &[u8]) -> Result<_rt::Vec<u8>, _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2264] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xda\x10\x01A\x02\x01\
A\x09\x01BQ\x01@\x01\x0aquery-names\x01\0\x04\0\x0eadd-user-query\x01\0\x01@\x01\
...
get-public-key\x01\x15\x01@\x07\x0dbase-key-names\x14derivation-algorithmz\x13de\
rivation-metadatas\x15derived-key-algorithmz\x14derived-key-metadatas\x0bextract\
ablez\x06usages\x05\0\x03\x04\0\x0aderive-key\x01\x16\x01@\x04\x08key-names\x0fe\
ncrypt-algo-idz\x10encrypt-metadatas\x09plain-txt\x05\0\x06\x04\0\x07encrypt\x01\
\x17\x01@\x04\x08key-names\x0fdecrypt-algo-idz\x10decrypt-metadatas\x0acipher-tx\
t\x05\0\x06\x04\0\x07decrypt\x01\x18\x01@\x04\x08key-names\x0csign-algo-idz\x0ds\
ign-metadatas\x03txt\x05\0\x06\x04\0\x04sign\x01\x19\x01@\x05\x08key-names\x0csi\
gn-algo-idz\x0dsign-metadatas\x03txt\x05\x09signature\x05\0\x10\x04\0\x06verify\x01\
\x1a\x01@\x03\x07algo-idz\x0dhash-metadatas\x03txt\x05\0\x06\x04\0\x06digest\x01\
\x1b\x01@\x0a\x10decrypt-key-names\x0fdecrypt-algo-idz\x10decrypt-metadatas\x12k\
ey-name-to-imports\x0akey-formatz\x10wrapped-key-data\x05\x09algorithmz\x0dalgo-\
metadatas\x0bextractablez\x06usages\x05\0\x03\x04\0\x0aunwrap-key\x01\x1c\x01@\x05\
\x12key-name-to-exports\x0akey-formatz\x10encrypt-key-names\x0fencrypt-algo-idz\x10\
encrypt-metadatas\0\x06\x04\0\x08wrap-key\x01\x1d\x01@\x01\x08key-names\0\x08\x04\
\0\x08save-key\x01\x1e\x01@\x01\x12key-persist-paramss\0\x08\x04\0\x0bpersist-ke\
y\x01\x1f\x04\0\x08load-key\x01\x15\x04\0\x0adelete-key\x01\x1e\x04\0\x1egenerat\
e-simple-encryption-key\x01\x1e\x04\0\x1bgenerate-simple-signing-key\x01\x1e\x01\
@\x02\x08key-names\x09plain-txt\x05\0\x06\x04\0\x0esimple-encrypt\x01\x20\x01@\x02\
\x08key-names\x0acipher-txt\x05\0\x06\x04\0\x0esimple-decrypt\x01!\x01@\x02\x08k\
ey-names\x03txt\x05\0\x06\x04\0\x0bsimple-sign\x01\"\x01@\x03\x08key-names\x03tx\
t\x05\x09signature\x05\0\x10\x04\0\x0dsimple-verify\x01#\x01@\x01\x03txt\x05\0\x06\
\x04\0\x0dsimple-digest\x01$\x01@\x01\x03lenz\0\x06\x04\0\x10get-random-bytes\x01\
%\x01@\x01\x07requests\0\x03\x04\0\x0bhttps-query\x01&\x01@\0\x01\0\x04\0\x0fsta\
rt-recording\x01'\x04\0\x0estop-recording\x01'\x04\0\x12cancel-transaction\x01'\x03\
\x01\x0dklave:sdk/sdk\x05\0\x01@\0\x01\0\x04\0\x0fregister-routes\x01\x01\x01@\x01\
\x03cmds\x01\0\x04\0\x10load-from-ledger\x01\x02\x04\0\x10insert-in-ledger\x01\x02\
\x04\0\x04ping\x01\x01\x04\0\x05ping2\x01\x01\x04\x01\x1fcomponent:rust-template\
